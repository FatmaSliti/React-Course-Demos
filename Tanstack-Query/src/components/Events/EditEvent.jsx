...
export default function EditEvent() {
  ...
  const { mutate } = useMutation({
    ...
    onSettled: () => { //force react query to refetch the data behind the scenes to make sure that we fetch the latest data from the backend (even though everything is okay)
