...
export default function FindEventSection() {
  ...
  const { data, isLoading, isError, error } = useQuery({
    ...
    enabled: searchTerm !== undefined, //if it's undefined which is the initial value this query will be disabled BUT if the search term is anything else including the empty string the request will be sent
  });
