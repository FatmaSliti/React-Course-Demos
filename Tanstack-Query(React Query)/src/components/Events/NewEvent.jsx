...
export default function NewEvent() {
  ...
  function handleSubmit(formData) {
    mutate({ event: formData }) //this will send the request above creacted with useMutation because the useMutation  unlike the useQuery will only sent the request if we tell it to do with help of this mutate function
