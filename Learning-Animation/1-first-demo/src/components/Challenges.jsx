...
export default function Challenges() {
  ...
  return (
    <div id="challenges">
      ...
      >
        <AnimatePresence mode='wait'> {/* to not show the "No challenges found" text while animating (we also added the keys to the components inside the AnimatePresence ) */}
