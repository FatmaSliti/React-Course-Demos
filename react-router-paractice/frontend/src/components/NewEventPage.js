...
export const action = async ({ request, params }) => { //{request, params} to get the data from the form
    const data = await request.formData(); // we can benifit from this formData when use Form instead of form
    ...
    const eventData = {
        title: data.get('title'), //Title is the string stored in the name field of the title input
